...
> Для взаимодействия с GitHub API можно использовать библиотеку [Octokit.js](https://github.com/octokit/octokit.js/#readme), которая рекомендована инструкцией. Однако, я постараюсь описать всё без её использования, обычными запросами через инферфейсы fetch() или axios.
