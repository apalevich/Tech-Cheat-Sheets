...
После получения IP-адреса выполняется подключение по TCP. Оно состоит из инициализации (handshaking) и режима передачи данных, в котором можно отправлять запросы.
## Отправка запроса
...
3. Содержимое, которое браузер отобразит в качестве содержимого страницы
