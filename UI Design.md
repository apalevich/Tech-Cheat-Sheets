...
# Выcтраиваем иерархию

Иерархия элементов — это важность элементов по отношению друг к другу. Цель построения иерархии — снижение визуального шума до уровня, при котором внимание пользователя не будет страдать от конкуренции за него.
## Текст

Не стоит пытаться выстроить иерархию, меняя размер шрифтов. Лучше варьировать жирность и цвет текста:

- Чем важнее текст, тем контрастнее текст
- Чем важнее блок текста, тем жирнее текст

Как правило, достаточно 3 цветов и 2 жирностей

![](media/Screenshot%202023-12-10%20at%2010.05.41.png)

Если важный текст всё ещё конкурирует с другими элементами, то вместо увеличения жирности/цветности этому тексту лучшего его снизить у других (неважных). Другой способ решить эту проблему — убрать подложку с фоном у неважных элементов

Избегай серого шрифта на цветном фоне — контраст там сильно падает. Вместо серого лучше выбрать светлый оттенок того же цвета

> [!tip] **Назло семантике**: Соблюдая html5-семантику элементов, попробуй использовать стили вопреки их подходу по умолчанию. Например, заголовок h1 можно сделать маленьким, сосредоточив внимание пользователя на контенте. Иные элементы (типа названия секций) можно вовсе скрыть

## Жирность и контрастность

Восприятие элементов можно балансировать между этими двумя настройками.

Хотя это касается и текста, легче объяснить на примере иконок и линий:

- В иконках не регулируется толщина, но мы можем их облегчить, сделав менее контрастными
- Если границу толщиной 1 пиксель трудно выравнять по контрастности, её можно сделать 2 пикселя с низкой контрастностью
...
Интерактивные элементы можно расположить в иерархии следующим образом:

- Первичное действие — сплошная заливка, контрастный фон отлично работают здесь.
- Вторичные действия — обводка по контуру или менее контрастные цвета фона.
- Прочие действия — стилизация этих действий как ссылок обычно является лучшим подходом.

Бывает трудно решить, как выделить деструктивные действия (например, удаление аккаунта). С ними логика такая же — они могут быть как ссылкой, так и кнопкой с выделением или без — в зависимости от того, являются ли они первичным действием.
# Словарь
