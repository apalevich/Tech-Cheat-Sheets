...
Расширения используют стандартные веб-технологии: HTML, CSS и JavaScript. Также они имеют доступ к стандартным браузерным API ([список](https://developer.mozilla.org/ru/docs/Web/API)) и к специальным Chrome Extensions API ([подробнее](https://developer.chrome.com/docs/extensions/reference/))
