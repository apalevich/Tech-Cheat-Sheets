...
- Скрипты — могут взаимодействовать со страницей, DOM, получать данные через Chrome API или сервис-воркер
- Сервис-воркеры — обработчик браузерных событий. не может взаимодействовать с веб-страницей напрямую
- Веб-страницы — HTML-код с доступом к Chrome API
...
КС имеет доступ к файлам в проекте расширения несколькими способами.
